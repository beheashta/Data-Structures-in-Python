...
class List:
    ...
    def prepend(self, value):
        ...
        -------------------------------------------------------
        """
        new = _List_Node(value, self._front)
    ...
    def index(self, key):
        ...
        while curr._value != key and found == False:
            curr = curr._next
            i += 1
            if curr._value == key:
                found = True
    ...
    def max(self):
        ...
        max_data = deepcopy(curr._value)
        
        for x in range(len(self)):
            if curr._value > max_data:
                max_data = deepcopy(curr._value)
    ...
    def min(self):
        ...
        min_data = deepcopy(curr._value)
        
        for x in range(len(self)):
            if curr._value < min_data:
                min_data = deepcopy(curr._value)
    ...
    def linear_search_aux(self, key, c, p, i):
        if c == None:  # empty list
            i = -1
        
        elif c._value != key:  # change this to make it recursive
            p = c
            c = c._next
            i += 1
            c, p, i = self.linear_search_aux(key, c, p, i)
    ...
    def _linear_search_r(self, key):
        ...
        current, previous, index = self.linear_search_aux(key, c, p, i)
    ...
    def intersection(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        thing = source1._front
        otherthing = source2._front
        
        while thing is not None and otherthing is not None:
            if thing._value == otherthing._value:
                self.append(thing)
                thing = thing._next
